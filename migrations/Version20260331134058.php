 ...
 */
final class Version20260331134058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE pay_on_delivery pay_on_delivery TINYINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE pay_on_delivery pay_on_delivery TINYINT NOT NULL');
