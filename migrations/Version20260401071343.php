 ...
 */
final class Version20260401071343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, method VARCHAR(50) NOT NULL, amount DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, is_completed TINYINT NOT NULL, order_ref_id INT NOT NULL, INDEX IDX_6D28840DE238517C (order_ref_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
