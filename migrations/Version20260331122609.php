 ...
 */
final class Version20260331122609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD telephone_number VARCHAR(180) NOT NULL, ADD address VARCHAR(180) NOT NULL, ADD city_id INT NOT NULL');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6498BAC62AF FOREIGN KEY (city_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP telephone_number, DROP address, DROP city_id');
    }
}
